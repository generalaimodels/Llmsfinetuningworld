...
def main(yaml_file_path: str):
    ...
    # Send telemetry
    send_example_telemetry("causal_language_model", model_args, data_args)
    ...
    if training_args.do_train:
        ...
        trainer.save_model(output_dir=training_args.output_dir)  # Saves the tokenizer too for easy loading
