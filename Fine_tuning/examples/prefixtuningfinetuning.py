...
# Constants
CONFIG_FILE_PATH = Path(r"C:\Users\heman\Desktop\Coding\LlmsComponents\Fine_tuning\peftrecipes\prefixfinetuning.yml")
...
peft_loraconfig=config_data.get('config1', {}).get('PrefixTuningConfig', {})
...
peft_config=PrefixTuningConfig(**peft_loraconfig)
