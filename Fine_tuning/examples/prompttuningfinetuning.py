...
# Constants
CONFIG_FILE_PATH = Path(r"C:\Users\heman\Desktop\Coding\LlmsComponents\Fine_tuning\peftrecipes\prompttuningtuning.yml")
...
peft_loraconfig=config_data.get('config1', {}).get('PromptTuningConfig', {})
...
peft_config=PromptTuningConfig(**peft_loraconfig)
